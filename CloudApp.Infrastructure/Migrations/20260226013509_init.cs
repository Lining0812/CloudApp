        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_T_MediaRelations_T_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "T_Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_T_MediaRelations_T_Concerts_ConcertId",
                        column: x => x.ConcertId,
                        principalTable: "T_Concerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        name: "FK_T_MediaRelations_T_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_MediaRelations_AlbumId",
                table: "T_MediaRelations",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_T_MediaRelations_ConcertId",
                table: "T_MediaRelations",
                column: "ConcertId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_T_MediaRelations_TrackId",
                table: "T_MediaRelations",
                column: "TrackId");
